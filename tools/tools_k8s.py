...
K8S_TOOLS["get_unhealthy_pods_detail"] = {
    ...
    "description": (
        ...
        "For threshold questions ('pods restarted more than 5 times'), call this tool and present "
        "results as a structured LIST — one entry per pod — never summarise into prose. "
        "Each list entry must include: pod name, namespace, restart count, and cause/reason. "
