    ...
    def _prepare_messages_for_hf(msgs: list, req_id: str = "") -> list:
        ...
        _TOOL_FORMATS = { # Unique prompt for individual tool
            ...
            "get_node_capacity": (
                ...
                "Node: [Node Name]"
                "--------------------------------------------------"
                "CPU: [Available] is more than or less than [Requested] -> [TRUE/FALSE]"
                "RAM: [Available] is more than or less than [Requested] -> [TRUE/FALSE]"
                ...
                "CPU: [50] is more than [100] -> FALSE"
                "RAM: [50] is more than [500] -> FALSE"
                "Fits on node: FALSE"
